...
class Neopixel:
    ...
    def __init__(self, num_leds, state_machine, pin, mode="RGB", delay=0.0001):
        ...
        if self.W_in_mode:
            ...
            self.sm = rp2.StateMachine(state_machine, sk6812, freq=8000000, sideset_base=Pin(pin, Pin.OUT))
            ...
            self.sm = rp2.StateMachine(state_machine, ws2812, freq=8000000, sideset_base=Pin(pin, Pin.OUT))
